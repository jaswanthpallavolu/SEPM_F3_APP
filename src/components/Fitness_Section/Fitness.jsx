...
export default function Fitness() {
    ...
    return (
        ...
        <div className="fitness_main" >
            ...
            <div className="heading"><h1> Fitness</h1></div>
            <div className="heading_2">
                <h1>Endurance</h1>
            </div>
            <div className="p1"><p>Endurance, or aerobic exercise, increase your breathing and heart rate. By doing endurance exercises, you are working to keep your heart, lungs, and circulatory system healthy while improving your total fitness.</p></div>
            ...
            <div className="p2">
                <p>
                    The purpose of flexibiity exercises is to stretch your muscles and help your body stay limber. This allows for more freedom of movement for other exercises and for everyday activities. Flexibility excercises also have the ability to improve your range of
                </p>
            </div>
            <div className="button">
                <p>
            ...
            <div className="p3">
                <p>
                    If you want to build up your muscles, then strength exercises are right for you! Strength exercises are also called "strength training" or "resistance training". Even the slightest increase in strength make a hugr difference in your ability to carry out everyday
                </p>
            </div>
            <div className="button">
                <p>
